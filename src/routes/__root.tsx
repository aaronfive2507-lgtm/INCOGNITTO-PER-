...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "INCOGNITTO — Inteligencia de experiencia del cliente" },
      {
        property: "og:description",
        content:
          "Mystery shopping, benchmark de competencia, auditoría de operaciones, capacitaciones, estudios de mercado y encuestas.",
      },
